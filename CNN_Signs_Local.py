...
def convolutional_model(input_shape):
  ...
  Z2 = tf.keras.layers.Conv2D(64, 3, strides=(1,1), padding='SAME', kernel_initializer='he_uniform')(P1)
  A2 = tf.keras.layers.ReLU()(Z2)
  P2 = tf.keras.layers.MaxPool2D(pool_size=(2, 2), strides=(2,2), padding='SAME')(A2)
  Z3 = tf.keras.layers.Conv2D(128, 3, strides=(1,1), padding='SAME', kernel_initializer='he_uniform')(P2)
  A3 = tf.keras.layers.ReLU()(Z3)
  P3 = tf.keras.layers.MaxPool2D(pool_size=(2, 2), strides=(2,2), padding='SAME')(A3)
  Z4 = tf.keras.layers.Conv2D(128, 3, strides=(1,1), padding='SAME', kernel_initializer='he_uniform')(P3)
...
best_model = tf.keras.models.load_model('./signs_best_model.h5')
